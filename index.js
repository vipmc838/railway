...
const UUID           = process.env.UUID           || '86addf84-2357-44de-8952-4ea00891bbb8'; // UUID，运行哪吒请修改
...
const ARGO_PORT      = Number(process.env.ARGO_PORT) || 9528;    // argo固定隧道端口
...
const NAME           = process.env.NAME           || 'Railway-GS';         // 节点名称
